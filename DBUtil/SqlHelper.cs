...
namespace DBUtil
{
    ...
    public sealed class SqlHelper
    {
        ...
        {
            return ConfigurationManager.ConnectionStrings["ExamDBConnectionString"].ToString();
        }
        /// <summary>
        /// 一个有效的数据库连接对象
        /// </summary>
        ...
        public static ArrayList ExecuteArrayList(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
