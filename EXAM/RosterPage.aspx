<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RosterPage.aspx.cs" Inherits="EXAM.RosterPage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="gvRoster" runat="server" Style="margin: 0 auto; text-align: center;" AutoGenerateColumns="False" Width="1031px" AllowSorting="True">
