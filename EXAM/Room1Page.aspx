<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Room1Page.aspx.cs" Inherits="EXAM.Room1Page" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="gvRoom1Seat" runat="server" Style="margin: 0 auto; text-align: center;" AutoGenerateColumns="False" Width="1031px" AllowSorting="True">
