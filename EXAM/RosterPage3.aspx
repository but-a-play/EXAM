<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RosterPage3.aspx.cs" Inherits="EXAM.RosterPage3" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="gvRoster3" runat="server" Style="margin: 0 auto; text-align: center;" AutoGenerateColumns="False" Width="1031px" AllowSorting="True">
