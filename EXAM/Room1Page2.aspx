<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Room1Page2.aspx.cs" Inherits="EXAM.Room1Page2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="gvRoom1Seat2" runat="server" Style="margin: 0 auto; text-align: center;" AutoGenerateColumns="False" Width="1031px" AllowSorting="True">
