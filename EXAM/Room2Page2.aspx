<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Room2Page2.aspx.cs" Inherits="EXAM.Room2Page2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="gvRoom2Seat2" runat="server" Style="margin: 0 auto; text-align: center;" AutoGenerateColumns="False" Width="1031px" AllowSorting="True">
